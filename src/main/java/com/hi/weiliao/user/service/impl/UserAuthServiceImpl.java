...
import com.hi.weiliao.skill.controller.UserAuthService;
...
public class UserAuthServiceImpl implements UserAuthService {
    ...
    private static ConcurrentHashMap<String, Integer> sessionToUserId = new ConcurrentHashMap();
    ...
    public String register(String phone, String password) {
        ...
        sessionToUserId.put(session, userAuth.getId());
        return session;
    }
    ...
    public String wxPhoneLogin(String openid, String encryptedData, String iv) {
        ...
        try {
            ...
            sessionToUserId.put(sessionKey, userAuth.getId());
        } catch (Exception e){
    ...
    private String createSession (){
        ...
        for (int i = 0; true; i++) {
            ...
            if (sessionToUserId.get(session) != null) {
                continue;
            }
            if (i == 5) {
